      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            <h3 className="font-skin text-lg font-bold">{city}</h3>
        ...
        <div className="flex items-center gap-4 border-t-2 border-skin-border pt-3">
          <div className="flex flex-col items-center">
            ...
            <span className="font-skin text-sm font-bold">{high}&deg;</span>
          </div>
          <div className="flex flex-col items-center">
            <span className="font-skin text-xs text-skin-text/60">Low</span>
            <span className="font-skin text-sm font-bold">{low}&deg;</span>
          </div>
          {humidity !== undefined && (
            <div className="flex flex-col items-center">
              <span className="font-skin text-xs text-skin-text/60">Humidity</span>
              <span className="font-skin text-sm font-bold">{humidity}%</span>
            </div>
          )}
        </div>
      </Card>
