    ...
    return (
      ...
      >
        <div className="flex flex-1 flex-col gap-2">
          <span className="font-skin text-3xl font-skin-bold leading-none text-skin-text">
            {time}
          </span>
          <span className="font-skin text-sm font-skin-medium text-skin-text/70">
            {label}
          </span>
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          {onDelete && (
            <button
              onClick={onDelete}
              className="font-skin text-xs font-skin-semibold text-skin-danger hover:underline"
